...
void SteppableRegionPublisher::heightmapConfigCallback(const jsk_recognition_msgs::HeightmapConfigConstPtr& msg) {
...
void SteppableRegionPublisher::heightmapCallback(const sensor_msgs::ImageConstPtr& msg)
{
